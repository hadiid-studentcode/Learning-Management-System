...
class RekapKeuanganTataUsahaController extends TataUsahaController
{
    /**
    ...
    public function report(Request $r, $jenis, $no_transaksi)
    {
        ...
        if ($r->tahun_ajaran && $r->month_day && $r->month) {
            return redirect('/tata-usaha/rekap-keuangan/search?tahunAjaran='.$r->tahun_ajaran.'&bulan='.$r->month_day.'-'.$r->month)->with('success', 'Data Berhasil Direport Silahkan Menunggu.');
        }
