...
@section('main')
    ...
    <div class="card card-custom gutter-b">
        <div class="card-body">
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#tambahSiswaModal">Tambah Siswa</button>
        </div>
    </div>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahSiswaModalLabel">Formulir Tambah siswa Kelas 4 Ibrahim</h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" id="kelas" name="kelas" disabled placeholder="Kelas 4 Ibrahim">
                                    </div>
