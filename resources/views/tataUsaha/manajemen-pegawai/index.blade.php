        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <p class="text-dark-50 mt-2 text-center">Silahkan Atur Data pegawai berupa Mengatur Bidang Studi Keahlian
                        dan
                    ...
                    <div class="modal-dialog modal-dialog-centered modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ url('/tata-usaha/manajemen-pegawai') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group" id="otherInputContainer_tataUsaha"
                                                style="display: none;">
                                                <label for="OtherJenis">Masukan Posisi:</label>
                                              

                                                <select class="form-control" name="posisi_tataUsaha"
                                                    id="other_jenis_tataUsaha">
                                                    <option value="" hidden>Pilih Posisi</option>
                                            ...
                                            <div class="form-group" id="otherInputContainer_pegawai" style="display: none;">
                                                <label for="OtherJenis">Masukan Posisi:</label>
                                                <input type="text" class="form-control" name="posisi_pegawai"
                                                    id="other_jenis_pegawai">
                                            ...
                                            <script>
                                                function toggleOtherInput() {
                                                    ...
                                                    const otherInputContainer_tataUsaha = document.getElementById("otherInputContainer_tataUsaha");
                                                    const otherInput_tataUsaha = document.getElementById("other_jenis_tataUsaha");
                                                    const otherInputContainer_pegawai = document.getElementById("otherInputContainer_pegawai");
                                                    const otherInput_pegawai = document.getElementById("other_jenis_pegawai");

                                                    if (selectElement.value === "Tata Usaha") {
                                                        otherInputContainer_tataUsaha.style.display = "block";
                                                        otherInput_tataUsaha.setAttribute("required", "true");
                                                    } else {
                                                        otherInputContainer_tataUsaha.style.display = "none";
                                                        otherInput_tataUsaha.removeAttribute("required");
                                                    }

                                                    if (selectElement.value === "Pegawai") {
                                                        otherInputContainer_pegawai.style.display = "block";
                                                        otherInput_pegawai.setAttribute("required", "true");
                                                    } else {
                                                        otherInputContainer_pegawai.style.display = "none";
                                                        otherInput_pegawai.removeAttribute("required");
                                                    }
                                                }
                                            </script>
                                                ...
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" accept="image/*"
                                                            ...
                                                            class="custom-file-input" id="lihatfile" name="foto">
                                                        <label class="custom-file-label" for="lihatfile"
                                                            id="file-label">Pilih foto</label>
                                                    </div>
                                                </div>
                                ...
                                <td>
                                    <div class="btn-sm" role="group" aria-label="Basic mixed styles example">
                                        <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                            data-target="#viewpegawai{{ $p->id }}"><i
                                            ...
                                            <div id="editpegawai{{ $p->id }}" class="modal fade">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form
                                                                action="{{ url('/tata-usaha/manajemen-pegawai/' . $p->id) }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="tempat-lahir">Tempat Lahir:</label>
                                                                            <input type="text" class="form-control"
                                                                                name="tempat_lahir" id="tempat-lahir"
                                                                                required value="{{ $p->tempat_lahir }}">
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            <label for="exampleInputFile">Input
                                                                                Foto</label>
                                                                            <div class="input-group">
                                                                                <div class="custom-file">
                                                                                    <input type="file" accept="image/*"
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control"
                                                                                ...
                                                                                required value="{{ $p->kabupatenKota }}">
                                                                        </div>
