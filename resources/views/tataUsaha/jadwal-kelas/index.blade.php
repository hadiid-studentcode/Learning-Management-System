        ...
        <div class="card card-custom gutter-b">
            <div class="card-body">
                <div class="table-responsive">
                        ...
                        @if (session('error'))
                        <div class="alert alert-warning d-flex justify-content-between align-items-center custom-alert" role="alert">
                            <div class="alert-content">
                                <i class="fas fa-exclamation-circle custom-icon"></i>
                                <strong class="custom-strong">Perhatian!</strong> Ada kesalahan yang perlu Anda ketahui Bahwa Terjadi {{ session('error') }}
                            </div>
                                                                ...
                                                                <div class="col-md-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="jumlah_pertemuan"
                                                                            ...
                                                                            required value="{{ $m->jumlah_pertemuan }}">
                                                                    </div>
                                                                </div> --}}
                                                                        </div>
                                                                    </div>
