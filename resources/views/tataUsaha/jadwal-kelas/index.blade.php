                                ...
                                <tbody>
                                    @foreach ($mapel as $m)
                                        <tr>
                                            ...
                                            {{-- <td>{{ $m->kode }}</td> --}}
                                            <td>{{ $m->hari }}</td>
                                            <td>{{ substr($m->waktu_mulai, 0, 5) }}-{{ substr($m->waktu_selesai, 0, 5) }}
                                            </td>
                                            <td>{{ $m->nama }}</td>
                                            <td>{{ $m->guru }}</td>
                                            ...
                                            <td>
                                                        ...
                                                        <div id="jadwalPopup">
                                                            <div class="modal fade bd-example-modal-lg"
                                                                ...
                                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h2 class="modal-title">Input Jadwal Pelajaran
                                                                            </h2>
                                                                        </div>
                                                                        <form
                                                                            action="{{ url('tata-usaha/manajemen-mata-pelajaran/' . $m->id) }}"
                                                                            id="jadwalForm" method="POST"
                                                                            accept-charset="utf-8">
                                                                            @csrf
                                                                            @method('PUT')
                                                                            <div class="modal-body">
                                                                                <div class="-fluid">
                                                                                    <div class="row">
                                                                                        <div class="col-sm-6">
                                                                                            <label
                                                                                                class="control-label">Hari:</label>
                                                ...
                                                <div class="modal fade" id="confirmDeleteModal{{ $m->id }}"
                            ...
                            @if ($mapel->lastPage() > 1)
                                <nav aria-label="Page navigation">
                                    <ul class="pagination justify-content-end">
                                        ...
                                        @else
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $mapel->previousPageUrl() }}"
                                                    rel="prev" aria-label="@lang('pagination.previous')">Previous</a>
                                            </li>
                                        @endif

                                        {{-- Pagination Elements with Limited Page Numbers --}}
                                        @foreach ($mapel->getUrlRange(max($mapel->currentPage() - 3, 1), min($mapel->currentPage() + 3, $mapel->lastPage())) as $page => $url)
                                        ...
                                        @if ($mapel->hasMorePages())
                                            <li class="page-item">
                                                <a class="page-link" href="{{ $mapel->nextPageUrl() }}" rel="next"
