        ...
        <div class="card card-custom" id="data_pertemuan">
            <div class="card-body">
                <div class="card-toolbar">
                    <ul class="nav nav-tabs nav-bold nav-tabs-line nav-tabs-line-3x d-flex flex-column align-items-center">
                        <li class="nav-item mb-3">
                            <a class="nav-link" href="{{ url('tata-usaha/manajemen-absensi') }}">
                                <span class="nav-icon">
                                    ...
                                    <span class="nav-text font-size-lg">Buka Absensi</span>
                                </span>
                            </a>
                        </li>
                        <li class="nav-item mb-3">
                            <a class="nav-link active" href="{{ url('tata-usaha/manajemen-absensi/create') }}">
                                <span class="nav-icon">
                                    ...
                                    <span class="nav-text font-size-lg">Edit Absensi</span>
                                </span>
                            </a>
                        </li>
                    </ul>
